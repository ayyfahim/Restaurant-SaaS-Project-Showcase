...
class SetmenuController extends Controller
{
    ...
    public function addsetmenu(Request $request)
    {
        ...
        if ($insert) {
            ...
            return Redirect::route("store_admin.setmenus")->with(Toastr::success('Set Menu Added successfully ', 'Success'));
        }
    }

    public function edit_setmenu(Request $request, $id)
    {
        // dd($request->all());
        $data = request()->validate([
            'name' => 'required',
        ...
        if ($insert) {
            ...
            if (isset($new_allergens) && $new_allergens[0] !== null) {
                try {
        ...
        return Redirect::route("store_admin.setmenus")->with(Toastr::success('Set Menu Updated successfully ', 'Success'));
    }
