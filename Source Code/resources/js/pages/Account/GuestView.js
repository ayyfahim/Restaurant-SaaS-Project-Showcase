...
import { leaveTable } from "../../actions/orderAction";
...
class GuestView extends React.Component {
        ...
        return (
            ...
            >
                ...
                <path
                    ...
                    fill="#ff0000"
                />
                <circle cx="131.82814" cy="239.22404" r="51" fill="#ff0000" />
                <path
    ...
    render() {
        ...
        return (
            <div className="bg-light-gray-2 vh-100 text-center py-5">
                <NotificationSystem ref={this.notificationSystem} />
                {this.returnGuestSvg()}

                <div className="px-2">
                    <h2 className="mb-4">Guest Mode</h2>
                    <div className="mb-5">
                    ...
                    <a
                        ...
                        class="btn btn-lg btn-info btn-primary-appetizr"
                    ...
                    {Object.keys(this.props?.table).length > 0 && (
                        <a
                            onClick={() => this.props.leaveTable()}
                            class="btn btn-lg btn-info btn-warning ml-3"
                            style={{ padding: "12px 40px" }}
                        >
                            Leave Table
                        </a>
