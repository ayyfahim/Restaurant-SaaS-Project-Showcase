    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <a class="btn btn-secondary"
                href="{{ route('kitchen_admin.kitchenlocation') }}">{{ auth()->user()->name }}</a>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-header border-0">
                                <div class="row">
                                    <div class="col-6">
                                        <h3 class="mb-0">Table #{{ $table['table_number'] }}</h3>
                                    </div>
                                    <div class="col-6">
