...
<body>
    ...
    <div class="main-content" id="panel">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
                        <div class="form-group mb-0">
                            ...
                            @if (url()->previous())
                            @isset($root_name)
                            @if ($root_name !== 'Dashboard')
                            <a href="{{ url()->previous() }}" class="col-12 p-0">
                                <h4><i class="fas fa-angle-left" style="font-size: 13px; color: #525f7f;"></i> Return
                                    Back</h4>
                            </a>
                            @endif
                            @else
                    ...
                    <ul class="navbar-nav align-items-center ml-md-auto">
                        ...
                        <li>
                            <a class="btn btn-primary btn-md" style="background-color: #322A7D"
                                href="http://wa.me/{{$sanboxNumber}}?text=join%20tongue-getting" target="_blank">Enable
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" src={{(Auth::user()->logo_url && Storage::disk('s3')->has(Auth::user()->logo_url)) ? Storage::disk('s3')->url(Auth::user()->logo_url) : asset("assets/images/avatar/1.jpg")}}>
                                        {{-- <img
                                            src="{{ Auth::user()->logo_url !=NULL ? Storage::disk('s3')->url(Auth::user()->logo_url) : asset("
                                            assets/images/avatar/1.jpg") }}"> --}}
                                    </span>
                                    @if (isset($IsStoreEnabled) && $IsStoreEnabled)
                                    <div class="media-body ml-2 d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold" style="color: #000000;">{{
                                            Auth::user()->store_name }}</span>
                                    </div>
                                    @else
        ...
        <script src={{asset("new/vendor/select2/dist/js/select2.full.min.js")}}></script>
