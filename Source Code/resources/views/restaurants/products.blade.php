    ...
    <div class="flex-row">
        ...
        <div class="main radio">
            <div style="float:left;" class="text-center pb-3 scrolling-wrapper col-md-6 mx-auto pos-menu">
                ...
                @endcan
                @can('view_products')
                    <button class="btn mt-2" style="background-color: rgba(211, 0, 0, 1); color: #fff">Products</button>
                @endcan
                @can('view_setmenus')
                            ...
                            <div class="col-md-3 target">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <img src="{{ $pro->image_url !=NULL ? Storage::disk('s3')->url($pro->image_url) : asset('themes/default/images/all-img/empty.png') }}"
                            ...
                            <div class="col-md-3 target">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <img src="{{ $nonveg->image_url !=NULL ? Storage::disk('s3')->url($nonveg->image_url) : asset('themes/default/images/all-img/empty.png') }}"
                                                    width="121" height="121" style="border-radius: 15px">
                                            </div>
                            ...
                            <div class="col-md-3 target">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <img src="{{ $veg->image_url !=NULL ? Storage::disk('s3')->url($veg->image_url) : asset('themes/default/images/all-img/empty.png') }}"
                                                    width="121" height="121" style="border-radius: 15px">
                                            </div>
                            ...
                            <div class="col-md-3 target">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <img src="{{ $prodesabled->image_url !=NULL ? Storage::disk('s3')->url($prodesabled->image_url) : asset('themes/default/images/all-img/empty.png') }}"
                                                    width="121" height="121" style="border-radius: 15px">
                                            </div>
...
@can('add_products')
<a href="{{route('store_admin.addproducts')}}" class="float btn-primary-appetizr">
