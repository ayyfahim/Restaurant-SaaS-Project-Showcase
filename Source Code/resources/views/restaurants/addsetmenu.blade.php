...
<div class="container-fluid mt-3">
    <div class="card mb-4">
        ...
        <!-- Card body -->
        <div class="card-body">
            <form id="cropper_form" method="post" action="{{ route('store_admin.addsetmenu_post') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-control-label" for="example3cols2Input">Menu Name</label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="cooking_time" value="{{old('cooking_time')}}" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sku" value="{{old('sku')}}" placeholder="SKU" required>
                        </div>
                    </div>
                </div>
                <div class="row">
