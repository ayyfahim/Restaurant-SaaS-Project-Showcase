...
<div class="container-fluid mt--6">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('store_admin.edit_products', ['id' => $data->id]) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-multiple" name="category_id" required>
                                ...
                                <option value="{{ $cat->id }}" {{ $data->category_id == $cat->id ? 'selected' : null }}>
                                    {{ $cat->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-multiple" name="addon_category_id[]" multiple>
                                ...
                                <option
                                    {{ $addon_category_items->pluck('addon_category_id')->contains($cat->id) ? 'selected' : '' }}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-multiple" name="allergens[]" multiple>
                                ...
                                <option value="{{ $cat->id }}"
                                    {{  $data->allergens->contains($cat->id) ? 'selected' : '' }}>{{ $cat->name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-multiple" name="time_restriction">
                                ...
                                <option value="{{ $restriction->id }}"
                                    {{ $data->time_restrictions->pluck('id')->contains($restriction->id) ? 'selected' : null }}>
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary btn-primary-appetizr" type="submit">Update Product</button>
                    </div>
    ...
    {{-- <form class="form-horizontal" method="post" action="{{route('store_admin.edit_products',['id'=>$data->id])}}"
    ...
    {{-- <div class="col-sm-10"> --}}
    {{-- <input type="text" name="cooking_time" value="{{$data->cooking_time}}" class="form-control"
