...
<div class="container-fluid">
    <div class="card mb-4">
        ...
        <div class="card-header">
            <h3 class="mb-0">Update Allergen</h3>
            @if (session()->has('MSG'))
        ...
        <!-- Card body -->
        <div class="card-body">
            <form method="post" action="{{ route('update_allergen', $allergen->id) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $allergen->name }}" name="name" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="type" required>
                                <option value="1" {{ $allergen->type == 1 ? 'selected' : '' }}>Allergen</option>
                                <option value="2" {{ $allergen->type == 2 ? 'selected' : '' }}>Food Preference</option>
                            </select>
                        </div>
                    </div>
